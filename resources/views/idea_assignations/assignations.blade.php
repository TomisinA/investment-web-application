                    ...
                    <table class="table table-striped table-bordered mt-5" id="dashboard">
                        ...
                        <tbody>
                            ...
                            @foreach ($assignations as $assignation)
                              <tr>
                                <td><a href="{{ route('show-idea', $assignation->idea->id) }}">{{$assignation->idea->title}}</a></td>
                                <td>{{ $assignation->investor->name }}</td>
                                <td>{{ ucfirst($assignation->status) }}</td>
                                <td>{{$assignation->created_at->format('Y-m-d')}}</td>
                              </tr>
                            @endforeach

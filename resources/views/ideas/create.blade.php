    ...
    <div class="form-container">
      <form method="POST" action="{{ route('create-idea') }}">
        ...
        <div class="form-group">
          ...
          <input type="text" name="abstract" value="{{old('abstract')}}">
        ...
        <div class="form-group">
            ...
            @foreach ($instruments as $instrument)
              <div class="checkbox-container">>
                  <input type="checkbox" name="instruments[]" id="instrument_{{ $instrument->id }}" value="{{ $instrument->id }}" >
        ...
        <div>
            ...
            <a href = " {{route('show-ideas')}} "><button type="button">Cancel</button></a>
        </div>

    ...
    <div class="Wrapper" style="width: 100%; display:flex;">
        <div class="sidebar" id="sidebar">
          ...
          <ul>
            ...
            <li><a class="mt-5" href="{{ route('create-idea-form') }}">Add Idea</a></li>
            <li>
                        ...
                        <tbody>
                            ...
                            @foreach ($ideas as $idea)
                              <tr>
                                ...
                                <td>
                                    <a href="{{ route('update-idea-form', $idea->id) }}"><span style="font-size: 1em; color: green;"><i class="fa-solid fa-pen-to-square"></i></span></a>

                                    <form action="{{ route('delete-idea', $idea->id) }}" method="POST" style="display: inline" > 
                                        @csrf
                                        @method('DELETE')
                                        <button class="button" style="background: none; border: 0px;">
                                            <span style="font-size: 1em; color: red;"><i class="fa-solid fa-trash"></i></span>
                                        </button>
                                    </form>
                                </td>
                              </tr>
